    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        ...
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('special_education.btn_edit')</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-content collapse show">
        <div class="card-body">
            <form action="{{ route('manage.special-education.update', $seStudent->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 form-group">
                        ...
                        <select name="student_id" class="form-control @error('student_id') is-invalid @enderror" required>
                            ...
                            @foreach($schoolUsers as $user)
                                <option value="{{ $user->id }}" {{ old('student_id', $seStudent->student_id) == $user->id ? 'selected' : '' }}>
                    ...
                    <div class="col-12 col-md-6 form-group">
                        ...
                        <select name="category" class="form-control @error('category') is-invalid @enderror" required>
                            ...
                            @foreach(['learning_disability','gifted','speech','physical','behavioral','visual','hearing','other'] as $cat)
                                <option value="{{ $cat }}" {{ old('category', $seStudent->category) === $cat ? 'selected' : '' }}>
                    ...
                    <div class="col-12 col-md-4 form-group">
                        ...
                        <select name="severity" class="form-control @error('severity') is-invalid @enderror">
                            ...
                            @foreach(['mild','moderate','severe'] as $sev)
                                <option value="{{ $sev }}" {{ old('severity', $seStudent->severity) === $sev ? 'selected' : '' }}>
                    ...
                    <div class="col-12 col-md-4 form-group">
                        ...
                        <select name="status" class="form-control @error('status') is-invalid @enderror" required>
                            @foreach(['active','inactive','graduated'] as $st)
                                <option value="{{ $st }}" {{ old('status', $seStudent->status) === $st ? 'selected' : '' }}>
                    ...
                    <div class="col-12 col-md-4 form-group">
                        ...
                        <select name="assigned_specialist" class="form-control @error('assigned_specialist') is-invalid @enderror">
                            ...
                            @foreach($schoolUsers as $user)
                                <option value="{{ $user->id }}" {{ old('assigned_specialist', $seStudent->assigned_specialist) == $user->id ? 'selected' : '' }}>
                                    {{ $isRtl && $user->name_ar ? $user->name_ar : $user->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12 form-group">
                        ...
                        <textarea name="diagnosis" rows="3" class="form-control @error('diagnosis') is-invalid @enderror">{{ old('diagnosis', $seStudent->diagnosis) }}</textarea>
                    ...
                    <div class="col-12 form-group">
                        ...
                        <textarea name="notes" rows="3" class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $seStudent->notes) }}</textarea>
                ...
                <div class="mt-1 d-flex gap-2">
                    ...
                    <a href="{{ route('manage.special-education.show', $seStudent->id) }}" class="btn btn-secondary">
