...
@section('title', __('appointments.schedule_create'))
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <h2 class="content-header-title float-{{ $isRtl ? 'right' : 'left' }} mb-0">
            @lang('appointments.schedule_create')
        </h2>
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('appointments.breadcrumb_create')</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-content collapse show">
        <div class="card-body">
            <form action="{{ route('manage.appointment-schedules.store') }}" method="POST">
                @csrf
                @include('appointments.schedules._form', ['schedule' => null])
