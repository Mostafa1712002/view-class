...
@section('title', __('class_visits.form.create_title'))
...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2">
        <h2 class="content-header-title mb-0">@lang('class_visits.form.create_title')</h2>
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">@lang('common.home')</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.class-visits.index') }}">@lang('class_visits.page_title')</a></li>
                <li class="breadcrumb-item active">@lang('class_visits.form.create_title')</li>
            </ol>
        </div>
    </div>
</div>
