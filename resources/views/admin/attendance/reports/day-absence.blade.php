...
<div class="content-body">
    ...
    <div class="card"><div class="card-body table-responsive">
        @if($rows->isEmpty())<div class="ds-empty"><div class="ds-empty-icon"><x-svg-icon name="calendar-x" :size="32" /></div><div class="ds-empty-title">لا توجد بيانات</div><div class="ds-empty-desc">اختر فترة لعرض البيانات.</div></div>
        @else
