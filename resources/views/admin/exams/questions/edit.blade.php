                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" name="marks" class="form-control @error('marks') is-invalid @enderror" value="{{ old('marks', $question->marks) }}" min="0.5" step="0.5" required>
                                @error('marks')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" name="order" class="form-control @error('order') is-invalid @enderror" value="{{ old('order', $question->order) }}" min="0">
                                @error('order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div id="optionsContainer">
                                ...
                                @foreach($options as $index => $option)
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" name="options[]" class="form-control" value="{{ $option }}" placeholder="الخيار {{ $index + 1 }}">
                                        <div class="input-group-text">
                                            <input type="radio" name="correct_option" value="{{ $index }}" {{ $correctAnswer === $option ? 'checked' : '' }}>
                        ...
                        <div id="trueFalseSection" class="mb-3" style="display: none;">
                            ...
                            <div class="d-flex gap-4">
                                <div class="form-check">
                                    <input type="radio" name="correct_answer_tf" value="true" class="form-check-input" id="tfTrue" {{ old('correct_answer_tf', $question->correct_answer) == 'true' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="tfTrue">صح</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" name="correct_answer_tf" value="false" class="form-check-input" id="tfFalse" {{ old('correct_answer_tf', $question->correct_answer) == 'false' ? 'checked' : '' }}>
                        ...
                        <div id="shortAnswerSection" class="mb-3" style="display: none;">
                            ...
                            <input type="text" name="correct_answer_short" class="form-control" value="{{ old('correct_answer_short', $question->type === 'short_answer' ? $question->correct_answer : '') }}" placeholder="الإجابة المتوقعة (اختياري)">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="explanation" class="form-control @error('explanation') is-invalid @enderror" rows="2" placeholder="شرح للإجابة الصحيحة">{{ old('explanation', $question->explanation) }}</textarea>
                            @error('explanation')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
@push('scripts')
<script>
    let optionCount = document.querySelectorAll('#optionsContainer .input-group').length;
