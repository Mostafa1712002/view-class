                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="max_exit_attempts" class="form-control @error('max_exit_attempts') is-invalid @enderror" value="{{ old('max_exit_attempts', $exam->max_exit_attempts) }}" min="1" max="50" required>
