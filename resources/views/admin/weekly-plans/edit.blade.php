...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-{{ app()->getLocale() === 'ar' ? 'right' : 'left' }} mb-0">تعديل الخطة الأسبوعية</h2>
...
<div class="content-body">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route($routePrefix . '.update', $weeklyPlan) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-12 mb-1">
                        ...
                        <input type="text" name="lesson_title" class="form-control" value="{{ old('lesson_title', $weeklyPlan->lesson_title) }}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-1">
                        ...
                        <textarea name="exams" class="form-control" rows="4">{{ old('exams', $weeklyPlan->exams) }}</textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 mb-1">
                ...
                <div class="mt-2">
                    ...
                    <a href="{{ route($routePrefix . '.show', $weeklyPlan) }}" class="btn btn-secondary">@lang('common.cancel')</a>
                </div>
            </form>
        </div>
    </div>
