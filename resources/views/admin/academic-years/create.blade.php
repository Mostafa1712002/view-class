...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-right mb-0">إضافة سنة دراسية</h2>
            ...
            <form action="{{ route('manage.academic-years.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="مثال: 1446-1447هـ" required>
                ...
                <div class="mt-3">
                    <button type="submit" class="btn btn-primary"><i data-feather="save"></i> حفظ</button>
