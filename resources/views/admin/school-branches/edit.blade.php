...
@section('title', __('school_branches.edit_branch'))
...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2">
        <h2 class="content-header-title float-{{ app()->getLocale() === 'ar' ? 'right' : 'left' }} mb-0">@lang('school_branches.edit_branch')</h2>
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('school_branches.edit_branch')</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="content-body">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.school-branches.update', $branch->id) }}" method="POST">
                @csrf
                @method('PUT')
