        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ request()->routeIs('admin.surveys.*') ? 'active' : '' }}" data-section="educational">
                <a href="{{ Route::has('admin.surveys.index') ? route('admin.surveys.index') : '#' }}">
                    <i class="la la-poll"></i><span class="menu-title">@lang('shell.nav_surveys')</span>
                </a>
            </li>
            @else
            ...
            @if($sidebarUser && $sidebarUser->isStudent())
                ...
                {{-- === Student subjects cards + content hub — card #171 === --}}<li class="nav-item {{ request()->routeIs('student.subjects.*') ? 'active' : '' }}" data-section="educational"><a href="{{ Route::has('student.subjects.index') ? route('student.subjects.index') : '#' }}"><i class="la la-th-large"></i><span class="menu-title">موادي</span></a></li>
                {{-- === Student special-education view — card #173 === --}}<li class="nav-item {{ request()->routeIs('student.special-education') ? 'active' : '' }}" data-section="educational"><a href="{{ Route::has('student.special-education') ? route('student.special-education') : '#' }}"><i class="la la-heart"></i><span class="menu-title">@lang('student.special_ed.title')</span></a></li>
