...
return [
    ...
    'owner_review_title' => 'Review school questions',
    'owner_review_hint' => 'Every school private bank and its questions in one place; open any bank and promote its best questions to a public or Al-Awwal bank.',
    'owner_review_empty' => 'No school private banks yet.',
    'owner_review_view' => 'View questions',
    'filter_school' => 'School',
    'filter_all_schools' => 'All schools',
    'col_questions' => 'Questions',
    'access_requests_title' => 'Al-Awwal bank access requests',
    'access_requests_empty' => 'No requests.',
    'access_req_bank' => 'Bank',
    'access_req_by' => 'Requested by',
    'access_req_status' => 'Status',
    ...
    'access_pending' => 'Awaiting approval',
    'action_request_access' => 'Request access',
    'action_copy_from_owner' => 'Copy to my school',
    'access_only_owner' => 'Requests apply only to Al-Awwal banks.',
    'access_not_granted' => 'Your access to this bank has not been approved yet.',
    'flash_access_requested' => 'Access request sent, awaiting the owner\'s approval.',
    'flash_access_decided' => 'Request status updated.',
    'flash_questions_copied' => 'Copied :count question(s) into “:bank”.',
    'copy_dest_invalid' => 'Copy destination must be a public or Al-Awwal bank.',
    'promote_pick_dest' => 'Pick a destination bank',
    'promote_selected' => 'Promote selected',
    'promote_none_selected' => 'No questions selected.',
    'notify_request_title' => 'Question bank access request',
    'notify_request_body' => 'School “:school” requested access to bank “:bank”.',
    'notify_decided_title' => 'Access request update',
    'notify_approved_body' => 'Your access to bank “:bank” was approved.',
    'notify_rejected_body' => 'Your access to bank “:bank” was rejected.',
];
