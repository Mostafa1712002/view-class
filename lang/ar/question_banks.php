...
return [
    ...
    'visibility_private_hint' => 'مرتبط بجهة واحدة فقط',
    ...
    'confirm_promote' => 'هل تريد ترقية هذا البنك إلى بنك عام متاح لجميع المدارس؟',
    ...
    'access_req_status' => 'الحالة',
    'access_status_pending' => 'قيد الانتظار',
    'access_status_approved' => 'مقبول',
    'access_status_rejected' => 'مرفوض',
    'access_approve' => 'قبول',
    'access_reject' => 'رفض',
    ...
    'notify_request_title' => 'طلب وصول لبنك أسئلة',
    'notify_request_body' => 'طلبت مدرسة «:school» الوصول إلى بنك «:bank».',
    'notify_decided_title' => 'تحديث طلب الوصول',
    'notify_approved_body' => 'تمت الموافقة على وصولك لبنك «:bank».',
    'notify_rejected_body' => 'تم رفض طلب وصولك لبنك «:bank».',
];
