...
return [
    ...
    'tpl' => [
        ...
        'dimension_warning_client' => 'تنبيه: يُفضّل أن تكون أبعاد الخلفية 3508×2479 بكسل، بينما الصورة المختارة :dims — يمكنك المتابعة.',
        'types' => [
            'appreciation' => 'شكر',
            'recognition'  => 'تقدير',
            'general'      => 'عام',
    ...
    'send_page' => [
        ...
        'sent_summary' => 'تم الإرسال عبر: :channels',
    ],
