...
return [
    ...
    'errors' => [
        'code_required_image' => 'يجب إدخال رمز أو كود للسؤال لتسهيل البحث عنه عند وجود خطأ.',
        'code_duplicate'      => 'كود السؤال مستخدم بالفعل داخل هذا البنك، يرجى إدخال كود مختلف.',
        'image_required'      => 'يجب رفع صورة السؤال عند اختيار «السؤال صورة كاملة».',
    ],
    ...
    'form' => [
        ...
        'body_ar_help' => 'غير مطلوب إذا كان السؤال صورة كاملة',
        'body_en' => 'نص السؤال (إنجليزي — اختياري)',
        'code' => 'كود السؤال',
        'code_placeholder' => 'مثال: Q-1024',
        'code_help' => 'اختياري للأسئلة النصية، وإلزامي إذا كان السؤال صورة كاملة. لا يتكرر داخل نفس البنك.',
        'content_type' => 'نوع المحتوى',
        'is_full_image' => 'السؤال صورة كاملة (بدون رأس سؤال نصي)',
